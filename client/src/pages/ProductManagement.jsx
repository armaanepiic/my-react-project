...
export default function ProductManagement() {
  ...
  const { search, isLoading, error, filteredProducts, products, getProductByName, totalPrice, handleProductSearch } = useProducts();
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={clsx(
            "mb-6 p-4 rounded-lg border text-center transition-colors duration-300",
