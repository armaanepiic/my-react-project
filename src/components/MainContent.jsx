    ...
    <main className="flex-1 p-8 transition-colors duration-300 bg-white text-gray-800">
      ...
      <div className="p-6 rounded-lg mb-6 bg-blue-50 border-2 border-blue-200">
        ...
        <ul className="space-y-2">
          ...
          <li>• All components share the same state without prop drilling!</li>
      ...
      <div className="p-6 rounded-lg bg-gray-50 border border-gray-200">
        ...
        <div className="flex gap-3">
          <input
            ...
            className={
              "flex-1 p-2 rounded-md border focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white border-gray-300 text-gray-800 focus:duration-300"
            }
          />
          <button
            onClick={() => {}}
